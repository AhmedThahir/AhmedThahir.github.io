...
![newplot (1).png](../assets/newplot_(1){ loading=lazy }_1696709605012_0.png)

![newplot (2).png](../assets/newplot_(2){ loading=lazy }_1696709617587_0.png)
...
![newplot.png](../assets/newplot_1696709496835_0.png){ loading=lazy }
...
![4d_surface_plot.png](./assets/4d_surface_plot.png){ loading=lazy }
...
![](assets/ridge_plot.png){ loading=lazy }
...
![](assets/ridge_plot-1.png){ loading=lazy }
