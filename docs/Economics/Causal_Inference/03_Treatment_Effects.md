...
| Term |                                                                                                                                                                                                                                                    | Meaning                                                                                                          | Useful for                                      |
| ---- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- | ----------------------------------------------- |
| ITE  | $\tau_i$                                                                                                                                                                                                                                           | Individual Treament Effect<br />it is never observed, because we only observe $y_i^0$ or $y_i^1$                 |                                                 |
| ATT  | $E[\tau \vert x = 1]$                                                                                                                                                                                                                              | Average Treatment effect on Treated                                                                              | Retrospective analysis of treatment<br>Planning |
| ATU  | $E[\tau \vert x = 0]$                                                                                                                                                                                                                              | Average Treatment effect on Untreated<br>ATU is what could have been obtained if control group got the treatment | Planning                                        |
| ATE  | $E[\tau]$                                                                                                                                                                                                                                          | Average Treatment Effect<br>ATE is what could have been obtained if everyone got the treatment                   | Planning                                        |
